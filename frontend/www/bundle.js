...
var _v = __webpack_require__(105);
...
var inputStyle = { padding: "4" };
var inputBoxStyle = { borderRadius: "5px" };
...
var ContactInput = function (_React$Component) {
  ...
  function ContactInput(props) {
    ...
    _this.state = {
      contactInfo: {
        ...
        uuid: _this.props.uuid || (0, _v2.default)()
      },
    ...
    _this.uploadContact = _this.uploadContact.bind(_this);
    return _this;
  }
  ...
  _createClass(ContactInput, [{
    ...
    key: 'uploadContact',
    value: function uploadContact(contactData) {
      (0, _axios2.default)({
        method: 'post',
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { name: 'interests',
            type: 'text',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'label',
            null,
            ' How close are you? (1 is least close) '
          ),
          _react2.default.createElement(
            'select',
            { name: 'proximity',
        ...
        _react2.default.createElement('input', { style: submitButtonStyle, type: 'submit', value: 'Submit' })
      );
    }
  }]);
...
var Button = function (_React$Component) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'button',
        { style: button, onClick: this.props.callback },
        ' ',
        this.props.text,
        ' '
      );
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(33),B=__webpack_require__(7),C=__webpack_require__(6),ba=__webpack_require__(34),da=__webpack_require__(35),ea=__webpack_require__(36),fa=__webpack_require__(37),ia=__webpack_require__(38),D=__webpack_require__(11);
...
var _ContactInput = __webpack_require__(14);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouterDom.Route, { path: '/contactform', component: _ContactInput2.default }),
        _react2.default.createElement(_reactRouterDom.Route, { path: '/contacts', component: _ContactList2.default })
      );
    }
  }]);
...
var HeaderButton = function (_React$Component) {
  ...
  function HeaderButton(props) {
    ...
    var _this = _possibleConstructorReturn(this, (HeaderButton.__proto__ || Object.getPrototypeOf(HeaderButton)).call(this, props));
  ...
  _createClass(HeaderButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        { to: this.props.path, style: navButtonStyle },
        ' ',
        this.props.label,
        ' '
      );
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'nav',
          { style: navBarStyle },
          _react2.default.createElement(HeaderButton, { path: '/contactform', label: 'Add contact' }),
          _react2.default.createElement(HeaderButton, { path: '/contacts', label: 'My Contacts' })
        )
      );
    }
  }]);
...
var _ContactCard = __webpack_require__(109);
...
var ContactServiceURL = 'http://localhost:3001/contact-data/load';
...
var ContactList = function (_React$Component) {
  ...
  function ContactList(props) {
    ...
    _this.loadContacts = function () {
      (0, _axios2.default)({
        ...
        Object.keys(response.data).map(function (contactKey) {
          if (!_this.state.contacts) _this.state.contacts = {};
          _this.state.contacts[contactKey] = response.data[contactKey];
        });
        _this.setState({ contacts: _this.state.contacts });
      });
    };
  ...
  _createClass(ContactList, [{
    ...
    key: 'render',
    value: function render() {
      if (!this.state.contacts) return _react2.default.createElement(
        'p',
        null,
        ' Loading contacts... '
      );
      return _react2.default.createElement(
        ...
        Object.keys(this.state.contacts).map(function (contactKey) {
          return _react2.default.createElement(_ContactCard2.default, { key: contactKey,
...
var _EditButton = __webpack_require__(110);

var _EditButton2 = _interopRequireDefault(_EditButton);

var _ArticleButton = __webpack_require__(111);
...
var ContactCard = function (_React$Component) {
  ...
  function ContactCard(props) {
    ...
    _this.getStyle = function () {
      return _this.state.hovered ? hover : unhover;
    };

    _this.state = { hovered: false, expanded: false };
    return _this;
  }
  ...
  _createClass(ContactCard, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'contact-card', onMouseOut: this.onUnhover, onMouseOver: this.onHover, style: this.getStyle() },
        _react2.default.createElement(
          'h1',
          { style: name },
          ' ',
        ...
        _react2.default.createElement(_EditButton2.default, { contactInfo: this.props.contactInfo }),
        _react2.default.createElement(_ArticleButton2.default, { contactInfo: this.props.contactInfo })
      );
    }
  }]);
		...
		_createClass(EditButton, [{
				...
				value: function render() {
						return _react2.default.createElement(
								'div',
								{ style: editButton },
								_react2.default.createElement(_Button2.default, { callback: this.editContact, text: buttonText }),
								this.state.editing ? _react2.default.createElement(
										'div',
										null,
										_react2.default.createElement(_ContactInput2.default, {
...
var buttonText = "find an article!";
var ArticleServiceURL = 'http://localhost:8080/articles_for_contacts';
...
var ArticleButton = function (_React$Component) {
  _inherits(ArticleButton, _React$Component);

  function ArticleButton(props) {
    _classCallCheck(this, ArticleButton);

    var _this = _possibleConstructorReturn(this, (ArticleButton.__proto__ || Object.getPrototypeOf(ArticleButton)).call(this, props));

    _this.findArticle = function () {
      (0, _axios2.default)({
        method: 'post',
        url: ArticleServiceURL,
        data: JSON.stringify(_this.props.contactInfo)
      }).then(function (response) {
  ...
  _createClass(ArticleButton, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { style: divStyle },
        _react2.default.createElement(_Button2.default, { callback: this.findArticle, text: buttonText }),
        _react2.default.createElement(
          'table',
          null,
          _react2.default.createElement(
            ...
            this.state.articles.map(function (article) {
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    'a',
                    { style: articles, href: article.link },
                    ' - ',
                    article.title,
                    ' '
                  )
